...
function Login() {
  ...
  return (
    <div className="w-full h-screen flex flex-col md:flex-row">
      ...
      {/* left hand side  */}
      <div className="w-full md:w-[40%] md:h-full dashboard_color">
        ...
        >
          ...
          >
            <h2 className="text-2xl  font-semibold text-black-800">
              Sign in to Instagram Automation
            </h2>
          ...
          <div className="mt-8">
            ...
            <div className="my-6">
              <button
                ...
                className="inline-block btn-hover3 rounded-md font-medium cursor-pointer text-center text-base py-3 px-6  w-full"
                type="submit"
              >
                {BtnDisabled === false ? (
                  "Login"
