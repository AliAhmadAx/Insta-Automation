...
import PricingCardYearly from "../Components/Cards/PricingCardYearly";
...
function Pricing() {
  ...
  return (
    <section
      className="py-20 bg-gray-900 mx-9 mt-10 rounded-xl"
    >
      <div className="w-full">
        <div className="w-full text-center flex flex-col items-center">
          <h2 className="lg:w-1/2 leading-tight w-full text-white text-4xl font-bold pb-5">
