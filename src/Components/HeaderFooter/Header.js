...
function Header({ showModal, setShowModal }) {
  ...
  const { DarkMode, setDarkMode, setHeaderShow } = useContext(ThemeContext);
  ...
  return (
    <div
      ...
      className="w-full h-[75px] backdrop-blur-3xl bg-white/30 shadow-lg"
    >
      ...
      <div className="w-full flex items-center justify-between px-5 py-3 ">
        <span className="self-center block lg:hidden">
        ...
        <div className="space-x-2 text-sm hidden lg:flex justify-center">
          <span
            ...
            className="self-center text-lg px-10"
          >
            Instagram Automation
          </span>
          ...
          <NavLink
            ...
            style={({ isActive }) =>
              DarkMode === true
                ...
                : {
                    color: isActive ? "var(--txtColor2)" : "var(--bgColor2)",
            ...
            className={
              DarkMode === true
                ...
                : "p-2 pl-8 btn-hover3 lg:px-4 md:mx-2 rounded transition-colors duration-300"
            }
            to="/"
          >
            Home
          ...
          <button
            ...
            className={
              DarkMode === true
                ...
                : "px-6 py-4 hidden btn-hover3 sm:flex items-center text-sm rounded-full"
            }
          ...
          <button
            ...
            className={
              DarkMode === true
                ...
                : "px-6 py-4 flex items-center shadow-lg  text-sm  btn-hover3 rounded-full"
            }
          >
