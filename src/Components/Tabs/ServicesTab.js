      ...
      {Screen === 2 ? (
        ...
        >
          <div className="w-full px-5 sm:px-10 lg:w-4/6 flex flex-col lg:flex-row">
            ...
            >
              <img src={dataext} alt="service image" />
            </div>
          ...
          <div className="w-full flex justify-center">
            <div className="w-full flex justify-center">
              <div
                className="border w-full lg:w-8/12 mt-10 lg:mt-20 py-5 bg-gray-900 px-5 md:px-10 lg:h-52 flex flex-col items-center justify-center"
              >
      ...
      {Screen === 3 ? (
        ...
        >
          ...
          <div className="w-full flex justify-center">
            <div className="w-full flex justify-center">
              <div
                className="border w-full lg:w-8/12 mt-10 lg:mt-20 bg-gray-900 py-5 px-5 md:px-10 lg:h-52 flex flex-col items-center justify-center"
              >
                <div className="flex flex-col items-center justify-center">
                  <div className="flex flex-col">
                    <h2
      ...
      {Screen === 4 ? (
        ...
        >
          ...
          <div className="w-full flex justify-center">
            <div className="w-full flex justify-center">
              <div
                // style={{ backgroundColor: "var(--bg-fill7)" }}
                className="border w-full lg:w-8/12 mt-10 lg:mt-20 bg-gray-900 py-5 px-5 md:px-10 lg:h-52 flex flex-col items-center justify-center"
              >
                <div className="flex flex-col items-center justify-center">
                  <div className="flex flex-col">
