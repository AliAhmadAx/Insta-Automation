      ...
      <div
        ...
        className={
          DarkMode === true
            ...
            : "w-72 pt-5 sm:w-[220px] hover:-translate-y-2 bg-gray-900 hover:duration-700 hover:shadow-lg  rounded-lg shadow-lg shadow-gray-200 flex flex-col items-start px-5"
        }
      >
        ...
        <p
          style={{ color: "var(--txtColor2)" }}
          className=" text-sm pt-2 pb-5"
        >
